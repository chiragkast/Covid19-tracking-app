...
input.addEventListener("input", function(){
    ...
    country_list.forEach( country => {
        if( country.name.toUpperCase().startsWith(value)){
            document.getElementById(country.name).classList.remove("hide");//when we write a country name short like india is ind then this line remove all other country name in the list
        }else{
            document.getElementById(country.name).classList.add("hide");//after entering the country name and show the result afterthat click bar is reset
        }
    })
})
...
function resetCountryList(){
    country_list.forEach( country => {
        document.getElementById(country.name).classList.remove("hide");//after clicking the country list the list will be reset
    })
}